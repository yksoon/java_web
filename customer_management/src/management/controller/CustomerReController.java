 ...
 */
public class CustomerReController implements Controller {
	...
	public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		ManagementDTO data = dao.selectAddMain(customerNo, null);
		
		ModelAndView mav = new ModelAndView("customer_add_mod_form");
