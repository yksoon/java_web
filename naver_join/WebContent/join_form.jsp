...
<title>네이버 회원 가입</title>
</head>
<body>
	<img alt="naver_logo" src="./img/naver_logo.PNG" height="20"> <br /><br />
	<form action="">
	<b>아이디</b> <br />
	<input type="text" name="ID" size="19" style="height: 30px;" placeholder="@naver.com" required="required" />
	<input type="button" name="check" value="중복확인" style="height: 30px;" />
	<br /><br />
	<b>비밀번호</b> <br />
	<input type="text" name="PW" size="30" style="height: 30px;" required="required" />
	<br /><br />
	<b>비밀번호 재확인</b> <br />
	<input type="text" name="PW2" size="30" style="height: 30px;" required="required" />
	<br /><br />
	<b>이름</b><br />
	<input type="text" name="name" size="30" style="height: 30px;" required="required" />
	<br /><br />
	<b>생년월일</b><br />
	<input type="text" name="year" size="10" style="height: 30px;" required="required" placeholder="년(4자)" />
	<select name="month" style="height: 36px;" required="required">
	...
	<input type="text" name="date" size="8" style="height: 30px;" required="required" placeholder="일" />
	<br /><br />
	<b>성별</b><br />
	<select name="gender" style="height: 36px; width: 243px" required="required">
	...
	<br /><br />
	<b>본인 확인 이메일</b><br />
	<input type="email" name="email" size="30" style="height: 30px;" placeholder="선택입력" />
	<br /><br />
	<b>휴대전화</b><br />
	<select name="phoneSelect" style="height: 36px; width: 243px" required="required">
	...
	<br />
	<input type="text" name="phone" size="19" style="height: 30px;" placeholder="전화번호 입력" />
	<input type="button" name="check" value="중복확인" style="height: 30px;" />
	<br /><br />
	<input type="submit" value="가입하기" style="border: 1; width: 240px; height: 80px;" />
	</form>
</body>
</html>